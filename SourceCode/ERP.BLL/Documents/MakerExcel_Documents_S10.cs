...
{
    internal class MakerExcel_Documents_S10
    {
        /// <summary>
        /// S10的报检
        /// </summary>
        ...
        public static void Bind_InspectionReceipt_S10<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionReceipt_Home:
                    ...
                    ExcelHelper.SetCellValue(sheet, 2, ExcelHelper.GetNumByChar('A'), "关于S10客人" + vm.PurchaseNumber + vm.HsName + "定单PO#:", cellStyle5);
                ...
                case MakerTypeEnum.InspectionReceipt_SaleContract:
                    ...
                    ExcelHelper.SetCellValue(sheet, 9, ExcelHelper.GetNumByChar('E'), "PO No.:" + vm.POID, cellStyle10);
                    ...
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S10/David.png", 75, 0, 800, 0, ExcelHelper.GetNumByChar('F'), thisRow, ExcelHelper.GetNumByChar('F'), thisRow + 5);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionCustoms_S10<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionClearance_S10<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            VMInspectionClearance vm = model as VMInspectionClearance;

            var font_12 = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Arial", 12, false);
            var font_12_bold = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Arial", 12, true);

            var font_11 = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Arial", 11, false);
            var font_11_bold = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Arial", 11, true);

            ICellStyle cellStyle = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11, HorizontalAlignment.Center, VerticalAlignment.Center, true);
            ICellStyle cellStyle_11_bold_center = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11_bold, HorizontalAlignment.Center, VerticalAlignment.Center, true);
            ...
            ICellStyle cellStyle_12_bold_right = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_12_bold, HorizontalAlignment.Right, VerticalAlignment.Center, false);
            cellStyle_12_bold_right.WrapText = false;

            ICellStyle cellStyle_11_bold_left_border_WrapText = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11_bold, HorizontalAlignment.Left, VerticalAlignment.Center, true);
            ICellStyle cellStyle_11_bold_left_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11_bold, HorizontalAlignment.Left, VerticalAlignment.Center, true);
            cellStyle_11_bold_left_border.WrapText = false;

            ICellStyle cellStyle_11_bold_left = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11_bold, HorizontalAlignment.Left, VerticalAlignment.Center, false);
            cellStyle_11_bold_left.WrapText = false;

            ICellStyle cellStyle_11_left_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_11, HorizontalAlignment.Left, VerticalAlignment.Center, true);
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionClearance_CommercialInvoice:
                    ...
                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('F'), "Inv. No.:" + vm.InvoiceNO, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('F'), "Date:" + CommonCode.GetDateTime3(vm.CreateDate), cellStyle_12_bold_left);

                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('A'), "TO:" + vm.AcceptInformation_CompanyName, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('A'), vm.AcceptInformation_StreetAddress, cellStyle_12_left);
                    ExcelHelper.SetCellValue(sheet, 8, ExcelHelper.GetNumByChar('A'), vm.AcceptInformation_CustomerReg, cellStyle_12_left);

                    ExcelHelper.SetCellValue(sheet, 10, ExcelHelper.GetNumByChar('A'), "Loading port: " + vm.PortName + ", CHINA", cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 11, ExcelHelper.GetNumByChar('A'), "Destination: " + vm.DestinationPortName + ", USA", cellStyle_12_bold_left);

                    ExcelHelper.SetCellValue(sheet, 12, ExcelHelper.GetNumByChar('G'), " Terms of Sale: FOB " + vm.PortName + ",CHINA", cellStyle_12_bold_right);
                    ...
                    var temp_list_OrderProduct = vm.list_OrderProduct_Invoice.GroupBy(d => d.HTS);

                    foreach (var item2 in temp_list_OrderProduct)
                    {
                        int Qty2 = 0;
                        int BoxQty2 = 0;
                        decimal SumSalePrice2 = 0;

                        foreach (var item in item2)
                        {
                            Qty2 += item.Qty;
                            BoxQty2 += item.BoxQty ?? 0;
                            SumSalePrice2 += item.SumSalePrice;
                            ...
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), item.SkuNumber, cellStyle);
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), item.Qty, cellStyle);
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), item.Desc, cellStyle_11_left_border);
                            ...
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), CommonCode.ListToString(item.list_Ingredient), cellStyle_11_left_border);
                        ...
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "Sub-total", cellStyle_11_bold_center);
                        ...
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), Qty2, cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), "The above are " + item2.First().HsEngName + ".HTS CODE " + item2.First().HSCode, cellStyle_11_bold_left_border_WrapText);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), "", cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), Keys.USD_Sign + Math.Round(SumSalePrice2, 2), cellStyle_11_bold_center);
                    ...
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "Total", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), Qty, cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), Keys.USD_Sign + Math.Round(SumSalePrice, 2), cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), "", cellStyle_11_bold_center);

                    ++thisRow;

                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "IN TOTAL " + CommonCode.GetEnMoneyString(SumSalePrice.ToString()) + " ONLY.", cellStyle_11_bold_left);

                    thisRow += 5;
                    ExcelHelper.CreatePicture_SaleContract(workbook, sheet, ExcelHelper.GetNumByChar('G'), thisRow, ExcelHelper.GetNumByChar('H'), thisRow + 6, 75, 0, 500, 0);
                ...
                case MakerTypeEnum.InspectionClearance_PackingList:
                    ...
                    var temp_list_OrderProduct2 = vm.list_OrderProduct_PackingList.GroupBy(d => d.CabinetIndex);
                    ...
                    foreach (var item2 in temp_list_OrderProduct2)
                    {
                        ...
                        int BoxQty2 = 0;
                        decimal SumSalePrice2 = 0;
                        decimal? SumOuterWeightGross2 = 0;
                        decimal? SumOuterWeightNet2 = 0;
                        decimal? SumOuterVolume2 = 0;

                        ExcelHelper.MyInsertRow(sheet, thisRow, 1, sheet.GetRow(thisRow));
                        ExcelHelper.AddMergedRegion(sheet, thisRow, thisRow, ExcelHelper.GetNumByChar('A'), ExcelHelper.GetNumByChar('I'));

                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "Container No.: " + item2.First().BoxNumber + "  Seal No.: " + item2.First().SealingNumber, cellStyle_11_bold_left_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), "", cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "", cellStyle_11_bold_center);
                        ...
                        foreach (var item in item2)
                        {
                            ...
                            SumOuterWeightGross2 += item.SumOuterWeightGross;
                            SumOuterWeightNet2 += item.SumOuterWeightNet;
                            SumOuterVolume2 += item.SumOuterVolume;
                            ...
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), item.No, cellStyle);
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), item.SkuNumber, cellStyle);
                            ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), item.Desc, cellStyle_11_left_border);
                        ...
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "", cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), "", cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), BoxQty2, cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), Qty2, cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), SumOuterWeightGross2, cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), SumOuterWeightNet2, cellStyle_11_bold_center);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('I'), SumOuterVolume2, cellStyle_11_bold_center);
                    ...
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), "", cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), BoxQty, cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), Qty, cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), SumOuterWeightGross, cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), SumOuterWeightNet, cellStyle_11_bold_center);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('I'), SumOuterVolume, cellStyle_11_bold_center);

                    ++thisRow;

                    thisRow += 5;
                    ExcelHelper.CreatePicture_SaleContract(workbook, sheet, ExcelHelper.GetNumByChar('F'), thisRow, ExcelHelper.GetNumByChar('H'), thisRow + 6, 75, 0, 500, 0);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionExchange_S10<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            var font_10 = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Times New Roman", 10, false);
            var font_10_bold = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Times New Roman", 10, true);
            ...
            ICellStyle cellStyle_10_bold_left = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_10_bold, HorizontalAlignment.Left, VerticalAlignment.Center, false);
            cellStyle_10_bold_left.WrapText = false;

            ICellStyle cellStyle_10_left = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_10, HorizontalAlignment.Left, VerticalAlignment.Center, false);
            cellStyle_10_bold_left.WrapText = false;


            ICellStyle cellStyle_10_bold_center_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_10_bold, HorizontalAlignment.Center, VerticalAlignment.Center, true);
            ICellStyle cellStyle_10_center_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_10, HorizontalAlignment.Center, VerticalAlignment.Center, true);

            ICellStyle cellStyle_10_left_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_10, HorizontalAlignment.Left, VerticalAlignment.Center, true);
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionExchange_CommercialInvoice:
                    ...
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('B'), vm.InvoiceNO, cellStyle_10_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('E'), Utils.DateTimeToStr5(vm.CreateDate), cellStyle_10_left_border);
                    ExcelHelper.SetCellValue(sheet, 8, ExcelHelper.GetNumByChar('C'), vm.POID + "," + vm.AcceptInformation_Comment, cellStyle_10_center_border);

                    ExcelHelper.SetCellValue(sheet, 4, ExcelHelper.GetNumByChar('F'), vm.AcceptInformation_CompanyName, cellStyle_10_left);
                    ExcelHelper.SetCellValue(sheet, 5, ExcelHelper.GetNumByChar('F'), vm.AcceptInformation_StreetAddress, cellStyle_10_left);
                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('F'), vm.AcceptInformation_CustomerReg, cellStyle_10_left);
                    ...
                    foreach (var item in vm.list_OrderProduct_Invoice)
                    {
                        ...
                        ExcelHelper.AddMergedRegion(sheet, thisRow, thisRow, ExcelHelper.GetNumByChar('E'), ExcelHelper.GetNumByChar('G'));

                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), item.No, cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), "", cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), item.Qty, cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), "CN", cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), item.Desc, cellStyle_10_left_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), "", cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), item.Desc, cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), Keys.USD_Sign + Math.Round(item.SalePrice, 2), cellStyle_10_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('I'), Keys.USD_Sign + Math.Round(item.SumSalePrice, 2), cellStyle_10_center_border);

                        ++thisRow;
                        ++i;
                    }

                    ExcelHelper.AddMergedRegion(sheet, 14, 13 + i, ExcelHelper.GetNumByChar('D'), ExcelHelper.GetNumByChar('D'));

                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), Qty, cellStyle_10_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), BoxQty, cellStyle_10_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('I'), Keys.USD_Sign + Math.Round(SumSalePrice, 2), cellStyle_10_center_border);

                    thisRow += 6;
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "Detp# " + vm.list_OrderProduct_PackingList.First().DepartmentName + ";" + vm.AcceptInformation_Comment, cellStyle_10_left_border);

                    thisRow += 4;
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S10/tom.png", 75, 0, 500, 0, ExcelHelper.GetNumByChar('H'), thisRow, ExcelHelper.GetNumByChar('I'), thisRow + 2);
