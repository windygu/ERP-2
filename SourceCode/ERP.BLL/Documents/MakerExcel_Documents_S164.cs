...
{
    internal class MakerExcel_Documents_S164
    {
        /// <summary>
        /// S164的报检
        /// </summary>
        ...
        public static void Bind_InspectionReceipt_S164<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionReceipt_Home:
                    ...
                    ExcelHelper.SetCellValue(sheet, 2, ExcelHelper.GetNumByChar('A'), "关于S164客人" + vm.PurchaseNumber + vm.HsName + "定单PO#:", cellStyle5);
                ...
                case MakerTypeEnum.InspectionReceipt_SaleContract:
                    ...
                    thisRow++;
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S164/DAVE.png", 75, 0, 800, 0, ExcelHelper.GetNumByChar('E'), thisRow, ExcelHelper.GetNumByChar('F'), thisRow + 5);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionCustoms_S164<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionClearance_S164<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            var font_14 = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Times New Roman", 14, false);
            var font_14_bold = ExcelHelper.GetFontStyle((HSSFWorkbook)workbook, "Times New Roman", 14, true);
            ...
            ICellStyle cellStyle_12_bold_left_border = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_12_bold, HorizontalAlignment.Left, VerticalAlignment.Center, true);
            ...
            ICellStyle cellStyle_14_left = ExcelHelper.GetCellStyle((HSSFWorkbook)workbook, font_14, HorizontalAlignment.Left, VerticalAlignment.Center, false);
            cellStyle_14_left.WrapText = false;
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionClearance_CommercialInvoice:
                    ...
                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('A'), "TO: " + vm.DestinationPort_CompanyName, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('A'), vm.DestinationPort_StreetAddress, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 8, ExcelHelper.GetNumByChar('A'), vm.DestinationPort_Address, cellStyle_12_bold_left);

                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('F'), "Inv. No.: " + vm.InvoiceNO, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('F'), "PO No.: " + vm.POID, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 8, ExcelHelper.GetNumByChar('F'), "Date: " + CommonCode.GetDateTime3(vm.CreateDate), cellStyle_12_bold_left);

                    ExcelHelper.SetCellValue(sheet, 11, ExcelHelper.GetNumByChar('A'), "Loading port: " + vm.PortName + ", CHINA", cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 12, ExcelHelper.GetNumByChar('A'), "Destination: " + vm.DestinationPortName, cellStyle_12_bold_left);

                    ExcelHelper.SetCellValue(sheet, 13, ExcelHelper.GetNumByChar('G'), " Terms of Sale: FOB " + vm.PortName, cellStyle_12_bold_right);
                    ...
                    foreach (var item in vm.list_OrderProduct_PackingList)
                    {
                        ...
                        ExcelHelper.MyInsertRow(sheet, thisRow, 1, sheet.GetRow(thisRow));
                        ExcelHelper.SetRowHeight(sheet, thisRow, 49f);

                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), item.SkuNumber, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), item.HSCode, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), item.No, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), item.Qty, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), item.Desc, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), Keys.USD_Sign + Math.Round(item.SalePrice, 2), cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), Keys.USD_Sign + Math.Round(item.SumSalePrice, 2), cellStyle_12_bold_center_border);
                    ...
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), Qty, cellStyle_12_bold_center_border);
                    ...
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), Keys.USD_Sign + Math.Round(SumSalePrice, 2), cellStyle_12_bold_center_border);

                    ++thisRow;

                    thisRow += 2;

                    ExcelHelper.CreatePicture_SaleContract(workbook, sheet, ExcelHelper.GetNumByChar('E'), thisRow, ExcelHelper.GetNumByChar('F'), thisRow + 6, 75, 0, 500, 0);

                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S164/ShippingMark.png", 75, 0, 400, 0, ExcelHelper.GetNumByChar('A'), thisRow, ExcelHelper.GetNumByChar('C'), thisRow + 2);

                    thisRow += 3;
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), vm.DestinationPortName, cellStyle_14_left);
                    ++thisRow;

                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "P.O. # " + vm.POID, cellStyle_14_left);
                ...
                case MakerTypeEnum.InspectionClearance_PackingList:
                    ...
                    ExcelHelper.SetCellValue(sheet, 5, ExcelHelper.GetNumByChar('A'), "TO: " + vm.DestinationPort_CompanyName, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 6, ExcelHelper.GetNumByChar('A'), vm.DestinationPort_StreetAddress, cellStyle_12_bold_left);
                    ExcelHelper.SetCellValue(sheet, 7, ExcelHelper.GetNumByChar('A'), vm.DestinationPort_Address, cellStyle_12_bold_left);
                    ...
                    ExcelHelper.SetCellValue(sheet, 11, ExcelHelper.GetNumByChar('H'), " Terms of Sale: FOB " + vm.PortName, cellStyle_12_bold_right);
                    ...
                    foreach (var item in vm.list_OrderProduct_PackingList)
                    {
                        ...
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), item.SkuNumber, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), item.No, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), item.Desc, cellStyle_12_bold_left_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), item.BoxQty, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), item.Qty, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), item.SumOuterWeightGross, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), item.SumOuterWeightNet, cellStyle_12_bold_center_border);
                        ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), item.SumOuterVolume, cellStyle_12_bold_center_border);
                    ...
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('A'), "TOTAL:", cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('B'), "", cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('C'), "", cellStyle_12_bold_left_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('D'), BoxQty, cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('E'), Qty, cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('F'), SumOuterWeightGross, cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('G'), SumOuterWeightNet, cellStyle_12_bold_center_border);
                    ExcelHelper.SetCellValue(sheet, thisRow, ExcelHelper.GetNumByChar('H'), SumOuterVolume, cellStyle_12_bold_center_border);
                    ...
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S164/ShippingMark.png", 0, 0, 250, 0, ExcelHelper.GetNumByChar('A'), thisRow, ExcelHelper.GetNumByChar('C'), thisRow + 2);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionExchange_S164<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
        }
    }
}