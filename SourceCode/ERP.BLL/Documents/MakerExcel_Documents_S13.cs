...
{
    class MakerExcel_Documents_S13
    {
        /// <summary>
        /// S13的报检
        /// </summary>
        ...
        public static void Bind_InspectionReceipt_S13<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            switch (makerTypeEnum)
            {
                case MakerTypeEnum.InspectionReceipt_Home:
                    ...
                    ExcelHelper.SetCellValue(sheet, 2, ExcelHelper.GetNumByChar('A'), "关于S13客人" + vm.PurchaseNumber + vm.HsName + "定单PO#: ", cellStyle5);
                ...
                case MakerTypeEnum.InspectionReceipt_SaleContract:
                    ...
                    ExcelHelper.SetCellValue(sheet, 9, ExcelHelper.GetNumByChar('E'), "PO No.:" + vm.POID, cellStyle7);
                    ...
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S13/tom.png", 75, 0, 800, 0, ExcelHelper.GetNumByChar('B'), thisRow + 1, ExcelHelper.GetNumByChar('C'), thisRow + 4);

                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S13/Mary.png", 75, 0, 800, 0, ExcelHelper.GetNumByChar('F'), thisRow, ExcelHelper.GetNumByChar('F'), thisRow + 5);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionCustoms_S13<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
            ...
            switch (makerTypeEnum)
            {
                ...
                case MakerTypeEnum.InspectionCustoms_SaleContract:
                    ...
                    ExcelHelper.CreatePicture(workbook, sheet, "/data/Documents/S13/Temmy.png", 75, 0, 800, 0, ExcelHelper.GetNumByChar('F'), thisRow, ExcelHelper.GetNumByChar('F'), thisRow + 5);
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionClearance_S13<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
        ...
        /// <param name="sheet"></param>
        /// <param name="makerTypeEnum"></param>
        public static void Bind_InspectionExchange_S13<T>(T model, IWorkbook workbook, HSSFSheet sheet, MakerTypeEnum makerTypeEnum)
        {
