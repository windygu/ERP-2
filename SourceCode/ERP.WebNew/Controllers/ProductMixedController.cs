...
using ERP.BLL.ERP.ProductMixed;
...
{
    [UserTrackerLog]
    [ERP.WebNew.Attributes.AuthorizedUser(PageID = (int)ERPPage.ProductManagement_ProductMixed)]
    public class ProductMixedController : Controller
    {
        private ProductMixedServices _productMixedServices = new ProductMixedServices();
        ...
        public ActionResult Index(VMProductSearchModel searchModel)
        {
            searchModel.PageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);

            var settings = _userService.GetUserCustomPageSettings(CurrentUserServices.Me.UserID, DatagridCustomColumnVisibilityModules.ProductMixedManagement_List);
        ...
        public ActionResult GetAll()
        {
            ...
            string productNO = HttpContext.Request["ProductNO"];
            string customerNo = HttpContext.Request["CustomerNo"];
            string factoryName = HttpContext.Request["FactoryName"];
            string keyWord = HttpContext.Request["KeyWord"];
            bool isQuoteProduct = false;
            bool.TryParse(HttpContext.Request["isquoteproduct"], out isQuoteProduct);
            ...
            List<VMProductInfo> products = _productMixedServices.GetAll(CurrentUserServices.Me, productNOs,
        ...
        {
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if ((pageElementPrivileges & (int)ProductMixedElementPrivileges.ViewProduct) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }

            VMProductInfo product = _productMixedServices.GetProductByID(CurrentUserServices.Me, ID);
            if (product == null)
            {
        ...
        {
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, new List<int>() { (int)ERPPage.ProductManagement_QuoteProduct_Management, (int)ERPPage.ProductManagement_ProductMixed });
            
                if ((id == 0 && (pageElementPrivileges & (int)ProductMixedElementPrivileges.CreateProduct) == 0) ||
                (id != 0 && (pageElementPrivileges & (int)ProductMixedElementPrivileges.EditProduct) == 0))
                {
                    return RedirectToAction("NoAuthPop", "Account");
                }
            

                ViewBag.Title = id == 0 ? "添加混装产品信息" : "修改混装产品信息";
            
            ViewData["IsView"] = false;
            ViewBag.ProductSingleSelection = false;
            ...
            if (openCached)
            {
                productInfo = _productMixedServices.GetOneCachedProduct(CurrentUserServices.Me.UserID, id);
            }
            else
            {
                if (id == 0)
                ...
                {
                    productInfo = _productMixedServices.GetProductByID(CurrentUserServices.Me, id);
                    if (productInfo == null)
                    {
                        return RedirectToAction("PageNotFind", "Account");
                    }
            ...
            ViewBag.SeasonList = _productMixedServices.GetSelectCustomer_SeasonList(productInfo.CustomerID, productInfo.Season);
        ...
        public ActionResult Edit(int id, [System.Web.Http.FromBody]VMProductInfo productInfo)
        {
            ...
            try
            {
                ...
                {
                    productInfo.ID = 0;
                    result = _productMixedServices.Create(CurrentUserServices.Me, CurrentUserServices.GetCurrentRequestIPAddress(), productInfo, productInfo.createAsQuote.HasValue && productInfo.createAsQuote.Value);
                }
                else
                {
                    result = _productMixedServices.Save(CurrentUserServices.Me, CurrentUserServices.GetCurrentRequestIPAddress(), productInfo);
                }

                // 删除缓存数据
                if (result != DBOperationStatus.Failed)
                {
                    _productMixedServices.RemoveOneCachedProduct(CurrentUserServices.Me.UserID, productInfo.ID);
                }
        ...
        public ActionResult SaveDraft(int id, [System.Web.Http.FromBody]VMProductInfo productInfo)
        {
            ...
            try
            {
                ...
                bool result = _productMixedServices.CacheOneProduct(CurrentUserServices.Me.UserID, productInfo);
        ...
        public ActionResult Delete([System.Web.Http.FromBody]string idList)
        {
            ...
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if (deleteList != null && deleteList.Count == 1 && (pageElementPrivileges & (int)ProductMixedElementPrivileges.DeleteProduct) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
            if (deleteList != null && deleteList.Count > 1 && (pageElementPrivileges & (int)ProductMixedElementPrivileges.BatchDelete) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
            
            DBOperationStatus result = _productMixedServices.Delete(CurrentUserServices.Me, deleteList, CurrentUserServices.GetCurrentRequestIPAddress());
            return new CustomJsonResult((short)result);
        }
        ...
        public ActionResult ViewProductList()
        {
            ...
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if ((pageElementPrivileges & (int)ProductMixedElementPrivileges.ViewProductCatelog) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
            ...
            List<VMViewProductList> list_vm = _productMixedServices.GetViewProductList(CurrentUserServices.Me, list);
        ...
        public ActionResult ViewLabelList()
        {
            ...
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if ((pageElementPrivileges & (int)ProductMixedElementPrivileges.ViewTagCatelog) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
            ...
            List<VMViewLabelList> list_vm = _productMixedServices.GetViewLabelList(CurrentUserServices.Me, list);
            return View(list_vm);
        }
        ...
        public ActionResult DownLoadLabelList()
        {
            ...
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if ((pageElementPrivileges & (int)ProductMixedElementPrivileges.DownloadCatelog) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
        ...
        {
            int pageElementPrivileges = _userService.GetPageElementsPrivileges(CurrentUserServices.Me, (int)ERPPage.ProductManagement_ProductMixed);
            if ((pageElementPrivileges & (int)ProductMixedElementPrivileges.ExportProductExcel) == 0)
            {
                return RedirectToAction("NoAuthPop", "Account");
            }
            ...
            if (collectons != null && !string.IsNullOrEmpty(collectons["SelectKeys"]))
            {
                ...
                List<VMProductInfo> products = _productMixedServices.GetProductByIDs(CurrentUserServices.Me, productIDs);
        ...
        public ActionResult SelectProduct()
        {
            ...
            List<VMProductInfo> listModel = _productMixedServices.SelectProduct(CurrentUserServices.Me, sortColumnsNames, sortColumnOrders, currentPage, pageSize, out totalRows,
             productNOs, customerID, FactoryName, includeQuoteProducts);
        ...
        public JsonResult GetProductInfoByQuote(VMProductInfoByQuote vm)
        {
            ...
            List<VMProductInfo> list_vm = _productMixedServices.GetProductInfoByQuote(CurrentUserServices.Me, vm);
        ...
        public JsonResult GetProductInfoByOrder(string idList, int CustomerID, int PortID)
        {
            ...
            List<VMProductInfo> list_vm = _productMixedServices.GetProductInfoByOrder(CurrentUserServices.Me, idArray, CustomerID, PortID);
            return Json(list_vm, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            int? CurrencyType = _productMixedServices.GetFactoryCurrencyType(FactoryID);
        ...
        {
            var list = _productMixedServices.GetSelectCustomer_SeasonList(CustomerID);
        ...
        {
            var list = _productMixedServices.GetProducts_Mixed(CurrentUserServices.Me, ID);
            return Json(list, JsonRequestBehavior.AllowGet);
        }
